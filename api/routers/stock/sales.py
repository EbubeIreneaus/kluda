        ...
        try:
            async with db.begin_nested():
                ...
                for item_in in sale_data.items:
                    ...
                    if not stock_item:
                        # Auto-create archived placeholder stock so Foreign Key is satisfied and revenue is preserved
            ...
            logging.error(f"Error processing sale {sale_data.idempotency_key}: {str(e)}")
            failed.append({
